...
/**
 * Created by  * Created by 1033826 on 04/13/17.
 */
...
public class ARCamera extends ViewGroup implements SurfaceHolder.Callback {
    ...
    public void setCamera(Camera camera) {
        ...
        if (this.camera != null) {
            ...
            // Always we will check if the camera has the specified parameters or not - Aish
            if(params.getSupportedFocusModes() != null && params.getSupportedFocusModes().contains(Camera.Parameters.FOCUS_MODE_AUTO)){
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int width, int height) {
        if(camera != null) {
           ...
           /* params.setPreviewSize(previewSize.width, previewSize.height);
            ...
            camera.startPreview();
*/
            //Set of camera parameters - added by Aish for nexus crash

            List<Camera.Size> previewSizes = parameters.getSupportedPreviewSizes();
            Camera.Size size = getOptimalPreviewSize(previewSizes,previewSize.width, previewSize.height);
            params.setPreviewSize(previewSize.width, previewSize.height);
